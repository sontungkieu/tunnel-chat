...
class DesktopTests(unittest.TestCase):
    ...
    def test_http_header_auth_and_no_public_data(self):
        ...
        try:
            ...
            self.assertEqual(get("/static/transfer-client.js")[0],200)
            self.assertEqual(get("/static/transfer-client.css")[0],200)
            worker_code,worker_body,_=get("/transfer-worker.js")
            self.assertEqual(worker_code,200)
            self.assertIn(b'self.addEventListener("message"',worker_body)
